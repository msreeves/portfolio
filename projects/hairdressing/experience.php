...
<body data-page="experience">
  ...
  <main>
    <section class="page-hero">
      <div class="container">
        <p class="eyebrow">Career &amp; education</p>
        <h1 data-experience-heading>Education and Experience</h1>
        <p class="muted" data-experience-text></p>
      </div>
    </section>

    <section id="experience-jobs">
      <div class="container">
        <div class="section-head"><h2>Work Experience</h2></div>
        <div class="timeline-grid" data-jobs-list></div>
      </div>
    </section>
    ...
    <section id="education">
      <div class="container">
        ...
        <div class="timeline-grid" data-education-list></div>
      </div>
    </section>
    ...
    <section id="contact">
      <div class="container">
        <div class="contact-panel">
          <h2 data-contact-heading>Get in Touch</h2>
          <p data-contact-phone></p>
          <p data-contact-email></p>
          <a class="btn btn-primary" href="./contact" style="margin-top:.75rem;display:inline-block">Send an Enquiry</a>
        </div>
      </div>
    </section>
  </main>
