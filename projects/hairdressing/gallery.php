...
<body data-page="gallery">
  ...
  <main>
    ...
    <section class="section-gallery-full">
      <div class="container">
        <div class="gallery-grid gallery-grid--full" data-gallery-full></div>
      </div>
    </section>
  </main>

  <!-- Lightbox -->
  <div class="lightbox" id="lightbox" aria-modal="true" role="dialog" aria-label="Image lightbox" aria-hidden="true">
